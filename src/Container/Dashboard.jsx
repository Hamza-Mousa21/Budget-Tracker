         ...
         <div className="col-9 col-md-9 col-lg-9 p-4 p-lg-5">
          ...
          <div className="mb-4">
            ...
            <div className="d-flex align-items-center gap-2 text-muted">
              ...
              ></span>
              <span style={{ fontSize: "1rem" }}>Overview for April 2026</span>
            </div>
          </div>
              ...
              >
                ...
                <div className="card-body p-4">
                  <div className="d-flex justify-content-between align-items-center">
                    <div>
                      <p className="text-secondary mb-2 fw-medium">Monthly Income</p>
            ...
            <div className="col-md-4">
              ...
              >
                ...
                <div className="card-body p-4">
                  <div className="d-flex justify-content-between align-items-center">
                    <div>
                      <p className="text-secondary mb-2 fw-medium">Total Expenses</p>
                      <h2 className="fw-bold mb-1" style={{ fontSize: "2.5rem" }}>
                        $0
                      </h2>
                      <small style={{ color: "#f97316", fontWeight: 500 }}>
                        No income set
                      </small>
                    </div>
            ...
            <div className="col-md-4">
              ...
              >
                ...
                <div className="card-body p-4">
                  <div className="d-flex justify-content-between align-items-center">
                    <div>
                      <p className="text-secondary mb-2 fw-medium">Remaining Balance</p>
                      <h2 className="fw-bold mb-1" style={{ fontSize: "2.5rem" }}>
                        $0
                      </h2>
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <div
                  ...
                  style={{ minHeight: "300px" }}
                >
                  <p className="text-muted mb-0 text-center" style={{ fontSize: "1.1rem" }}>
